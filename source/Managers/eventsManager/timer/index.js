...
export class CronJob {
    constructor(cronTime, onTick, onComplete, start, timeZone, context, runOnInit, utcOffset, unrefTimeout) {
        ...
        if (timeZone != null && utcOffset != null) {
            throw new Error.ExclusiveParametersError('timeZone', 'utcOffset');
        }
        if (timeZone != null) {
    ...
    _fnWrap(cmd) {
        ...
        switch (typeof cmd) {
            ...
            case 'string': {
                ...
                return window.require('child_process').spawn.bind(undefined, command !== null && command !== void 0 ? command : cmd, args, {});
            }
            case 'object': {
                return window.require('child_process').bind(undefined, cmd.command, (_a = cmd.args) !== null && _a !== void 0 ? _a : [], (_b = cmd.options) !== null && _b !== void 0 ? _b : {});
            }
        }
    }
